...
namespace FlatFiles.TypeMapping
{
    ...
    public static class CustomTypeMapper
    {
        ...
        public static ICustomTypeMapper<TEntity> Define<TEntity>()
            where TEntity : new()
        {
            return new CustomTypeMapper<TEntity>(() => new TEntity());
        }
        ...
        /// <returns>The configuration object.</returns>
        public static ICustomTypeMapper<TEntity> Define<TEntity>(Func<TEntity> factory)
        {
            if (factory == null)
            {
                throw new ArgumentNullException("factory");
            }
            return new CustomTypeMapper<TEntity>(factory);
        }
    }
    ...
    public interface ICustomTypeConfiguration<TEntity>
    {
        /// <summary>
        /// Gets the schema defined by the current configuration.
        /// </summary>
        /// <returns>The schema.</returns>
        CustomSchema GetSchema();
        ...
        /// <param name="window">Specifies how the fixed-width column appears in a flat file.</param>
        /// <returns>An object to configure the property mapping.</returns>
        ICustomComplexPropertyMapping ComplexProperty<TProp>(Expression<Func<TEntity, TProp>> property, ICustomTypeMapper<TProp> mapper, Window window);
    ...
    public interface ICustomTypeMapper<TEntity> : ICustomTypeConfiguration<TEntity>
    {
        /// <summary>
        ...
        IEnumerable<TEntity> Read(TextReader reader, CustomOptions options = null);
        ...
        ITypedReader<TEntity> GetReader(TextReader reader, CustomOptions options = null);
        ...
        void Write(TextWriter writer, IEnumerable<TEntity> entities, CustomOptions options = null);
        ...
        ITypedWriter<TEntity> GetWriter(TextWriter writer, CustomOptions options = null);
    }

    internal sealed class CustomTypeMapper<TEntity> : ICustomTypeMapper<TEntity>, IRecordMapper<TEntity>
    {
        ...
        public CustomTypeMapper(Func<TEntity> factory)
        {
        ...
        public ICustomComplexPropertyMapping ComplexProperty<TProp>(Expression<Func<TEntity, TProp>> property, ICustomTypeMapper<TProp> mapper, Window window)
        {
            PropertyInfo propertyInfo = getProperty(property);
            return getComplexMapping(propertyInfo, mapper, window);
        }

        private ICustomComplexPropertyMapping getComplexMapping<TProp>(PropertyInfo propertyInfo, ICustomTypeMapper<TProp> mapper, Window window)
        {
            IPropertyMapping mapping;
            if (!mappingLookup.TryGetValue(propertyInfo.Name, out mapping))
            {
                mapping = new CustomComplexPropertyMapping<TProp>(mapper, propertyInfo);
                mappings.Add(mapping);
                mappingLookup.Add(propertyInfo.Name, mapping);
            }
            windowLookup[mapping] = window;
            return (ICustomComplexPropertyMapping)mapping;
        }
        ...
        public IEnumerable<TEntity> Read(TextReader reader, CustomOptions options = null)
        {
            CustomSchema schema = getSchema();
            IReader CustomReader = new CustomReader(reader, schema, options);
            return read(CustomReader);
        }
        ...
        public ITypedReader<TEntity> GetReader(TextReader reader, CustomOptions options = null)
        {
            CustomSchema schema = getSchema();
            IReader CustomReader = new CustomReader(reader, schema, options);
            return getTypedReader(CustomReader);
        }
        ...
        public void Write(TextWriter writer, IEnumerable<TEntity> entities, CustomOptions options = null)
        {
            if (entities == null)
            {
            ...
            CustomSchema schema = getSchema();
            IWriter CustomWriter = new CustomWriter(writer, schema, options);
            write(CustomWriter, entities);
        }
        ...
        public ITypedWriter<TEntity> GetWriter(TextWriter writer, CustomOptions options = null)
        {
            CustomSchema schema = getSchema();
            IWriter CustomWriter = new CustomWriter(writer, schema, options);
            return getTypedWriter(CustomWriter);
        }
        ...
        private CustomSchema getSchema()
        {
